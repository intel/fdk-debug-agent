...
TEST_CASE("Test parameter serializer getChildren()")
{
    ...
    CHECK_THROWS_AS_MSG(children = parameterSerializer.getChildren("badSubsystem","aec",
    ...
    CHECK_THROWS_AS_MSG(children = parameterSerializer.getChildren("cavs", "badModule",
        ParameterSerializer::ParameterKind::Control),
        ParameterSerializer::Exception,
...
TEST_CASE("Test parameter serializer binary to xml")
{
    ...
    CHECK_NOTHROW(aecControlParameter =
        parameterSerializer.binaryToXml(
        "cavs",
        "aec",
        ParameterSerializer::ParameterKind::Control,
        children[0],
...
TEST_CASE("Test parameter serializer xml to binary")
{
    ...
    CHECK_NOTHROW(localAecControlParameterPayload =
        parameterSerializer.xmlToBinary(
        "cavs",
        "aec",
        ParameterSerializer::ParameterKind::Control,
        "AcousticEchoCanceler",
        xmlFile("instance_aec_control_params")));
